...
ExpressHbs.prototype.cachePartials = function(cb) {
  ...
  function readNext() {
    ...
    .on('warn', function(err) {
      console.warn('Non-fatal error in tretton37-markdown-site cachePartials.', err);
    })
    .on('error', function(err) {
      console.error('Fatal error in tretton37-markdown-site cachePartials', err);
      return cb(err);
    })
 ...
 *           'x-powered-by': true,
 *           env: 'production',
 *           views: '/home/coder/patolo/code/tretton37-markdown-site/app/views',
